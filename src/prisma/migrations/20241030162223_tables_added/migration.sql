...
-- CreateTable
CREATE TABLE "MindfulnessProfile" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "meditationExp" TEXT,
    "practices" TEXT[],
    ...
    CONSTRAINT "MindfulnessProfile_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "MindfulnessProfile_userId_key" ON "MindfulnessProfile"("userId");
...
-- AddForeignKey
ALTER TABLE "MindfulnessProfile" ADD CONSTRAINT "MindfulnessProfile_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
