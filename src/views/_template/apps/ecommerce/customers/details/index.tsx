...
const OverViewTab = dynamic(() => import('@/views/_template/apps/ecommerce/customers/details/customer-right/overview'))
const SecurityTab = dynamic(() => import('@/views/_template/apps/ecommerce/customers/details/customer-right/security'))
const NotificationsTab = dynamic(
  () => import('@/views/_template/apps/ecommerce/customers/details/customer-right/notification')
)

const AddressBillingTab = dynamic(
  () => import('@/views/_template/apps/ecommerce/customers/details/customer-right/address-billing')
)
